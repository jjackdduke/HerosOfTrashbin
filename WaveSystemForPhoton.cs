...
{       
        ...
        new EnemyWavesData (1.5f, 10, 150, "Path_1_1", 1, 8f, 1f ), //1
        new EnemyWavesData (1f, 10, 160, "Path_1_1", 1, 10f, 7f ), //2
        new EnemyWavesData (1.5f, 10, 170, "Path_1_1", 1, 10f, 3f), // 3
        new EnemyWavesData (1.5f, 5, 180, "Path_1_1", 1, 20f, 1f ), // 4
        new EnemyWavesData (2f, 10, 200, "Path_1_1", 1, 10f, 3f ), // 5
        ...
        {
        // 소환딜레이 - 최대 몹 개수 - 몹 HP - 길 - 라이프 패널티 - 속도 - 아머
        new SpecialEnemyWaveData (2f, 1, 700, "Path_1_1", 100, 12f, 10f, 10, 5f,75,50 ), //1
        new SpecialEnemyWaveData  (2f, 1, 1100, "Path_2_5", 100, 15f, 15f, 20, 5f,100,50 ), //2
        new SpecialEnemyWaveData  (2f, 1, 1500, "Path_1_3", 100, 20f, 20f, 30, 5f,75,50 ), // 3
        };
